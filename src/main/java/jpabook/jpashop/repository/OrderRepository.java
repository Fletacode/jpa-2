...
public class OrderRepository {
    ...
    public List<Order> findAllOrdersMemberOrderItemsDelivery(){
    ...
    public List<Order> findAllOrdersFetchJoin(){
        String jqpl = "select distinct o from Order o " +
    ...
    public List<Order> findAllOrdersFetchBatchSize(){
        String jqpl = "select distinct o from Order o" +
                " join fetch o.member m " +
                " join fetch o.delivery d";
